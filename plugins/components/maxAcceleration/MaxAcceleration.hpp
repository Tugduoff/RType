...
** RType
** File description:
** MaxAcceleration.hpp file
*/

#ifndef MAX_ACCELERATION_HPP
    #define MAX_ACCELERATION_HPP
...
namespace Components {
    /**
     * @brief MaxAcceleration component class in Components.
     * 
     ...
     */
    class MaxAcceleration : public AComponent<MaxAcceleration> {
    public:
         ...
         */
        MaxAcceleration(libconfig::Setting &config) : AComponent("MaxAcceleration")
        {
        ...
        /**
         * @brief Parameterized constructor for the MaxAcceleration component.
         * 
         ...
         */
        MaxAcceleration(int32_t forward = 2, int32_t backward = 1, int32_t right = 1, int32_t left = 1) :
            AComponent("MaxAcceleration"), forward(forward), backward(backward), right(right), left(left) {
            };

        /**
         * @brief Default destructor for the MaxAcceleration component.
         */
        ...
        /**
         * @brief Adds the MaxAcceleration component to an entity.
         * 
        ...
        void addTo(ECS::Entity &to, Engine::GameEngine &engine, std::vector<std::any> args) override {
            if (args.size() != 4)
                throw std::runtime_error("Invalid number of arguments for MaxAcceleration component");
            ...
            engine.getRegistry().componentManager().addComponent<Components::MaxAcceleration>(to, engine.newComponent<Components::MaxAcceleration>(forward, backward, right, left));
        };
        ...
        void addTo(ECS::Entity &to, Engine::GameEngine &engine, libconfig::Setting &config) override {
            ...
            attachAndUpdateComponent<Components::MaxAcceleration>(
                engine, to,
