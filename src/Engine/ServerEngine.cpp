...
** RType
** File description:
** ServerEngine.cpp file
*/

#include "ServerEngine.hpp"
#include <libconfig.h++>

std::shared_ptr<Components::IComponent> Engine::ServerEngine::getComponentFromId(const std::string &componentId)
{
...
void Engine::ServerEngine::loadSystems(const std::string &systemsConfigFile)
{
...
void Engine::ServerEngine::initSystems()
{
    __registry.systemManager().initSystems(*this);
}

void Engine::ServerEngine::runSystems()
{
